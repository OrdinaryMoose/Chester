...
## 1. What the system is (designer comment: not a requirement, but "design language" is an organizing principle of how do i design to account for the channeling principle)
...
## 2. The channeling principle (designer comment: accounting for this **is** a requirement)
