...
- `inference_pattern`: one of the closed-set patterns (§3.4.1)
...
- `grounds-imply-conclusion`: ordinary modus-ponens-flavored inference from facts to claim
- `rule-applies-to-case`: a Rule's prohibition or obligation extends to this Proposition's case
- `permission-licenses-relaxation`: an exception to a Rule that this Proposition depends on
