...
1. **Create Failing Test Case**
   ...
   - Use the `execute-test` skill for writing proper failing tests
...
**Related skills:**
- **execute-test** - For creating failing test case (Phase 4, Step 1)
- **execute-prove** - Verify fix worked before claiming success
