...
Independent and complementary to `plan-attack`.

- `plan-attack` attacks internal logic and execution feasibility
...
- This skill reviews plans. For reviewing existing code, use `util-codereview`.
