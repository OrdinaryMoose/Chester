...
# Version at v0006 (overlay landed at v0002; later bumps: directive protocol, verbosity-ladder re-anchor, design-large-task scrub, PM-Litmus + Research-Boundary canonical homes).
grep -q '^version: v0006$' "$SKILL" || { echo "FAIL: version not v0006" >&2; FAIL=1; }
