...
1. **Create Failing Test Case**
   ...
   - Use the `chester-test-first` skill for writing proper failing tests
...
**Related skills:**
- **chester-test-first** - For creating failing test case (Phase 4, Step 1)
- **chester-prove-work** - Verify fix worked before claiming success
