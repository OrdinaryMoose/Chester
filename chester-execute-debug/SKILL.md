...
1. **Create Failing Test Case**
   ...
   - Use the `chester-execute-test` skill for writing proper failing tests
...
**Related skills:**
- **chester-execute-test** - For creating failing test case (Phase 4, Step 1)
- **chester-execute-prove** - Verify fix worked before claiming success
